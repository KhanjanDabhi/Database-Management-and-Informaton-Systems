						...
						<ul>
							...
							<li><span class="spcl"><i class="fa fa-male" aria-hidden="true"></i> Faculty area</span></li>
								<ul>
									...
									<li><a href="fct_profile.php"><i class="fa fa-user" aria-hidden="true"></i> profile</a></li>
							...
							<li><span class="spcl"><i class="fa fa-university" aria-hidden="true"></i> Registry</span></li>
								<ul>
									<li><a href="#"><i class="fa fa-plus" aria-hidden="true"></i> Admission</a></li>
									<li><a href="#"><i class="fa fa-building" aria-hidden="true"></i> Accounts</a></li>
								</ul>
						</ul>
